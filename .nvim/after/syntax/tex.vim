...
syn match arrowheadr 'arrow' transparent contained conceal cchar=>
syn match arrowheadl 'arrow' transparent contained conceal cchar=>

syn match texMathSymbol '\\Rightarrow\>' contained contains=arrowheadr conceal cchar==
syn match texMathSymbol '\\Leftarrow\>' contained contains=arrowheadl conceal cchar==
syn match texMathSymbol '\\rightarrow\>' contained contains=arrowheadr conceal cchar=-
syn match texMathSymbol '\\leftarrow\>' contained contains=arrowheadl conceal cchar=-
